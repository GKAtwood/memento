...
class Dashboard extends Component{
    constructor(){
        ...
        logout(){
            axios.post('/api/memento/users/logout').then(res=>{
                this.props.login({
                    uid: 0,
                    firstName: '',
                    lastName: '',
       ...
       return(
        <div className="dashboard">
                ...
                <aside className="all-header">
                    ...
                    <Link to='/dashboard/inspire'><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQl679HqNTHtCIGPWQ60ca5TdYB5GG7mSBhFQ&usqp=CAU" alt="Inspiration" className="icon"  width="30"/></Link>
